...
class Messages {
    ...
    public function init() {
        ...
        $this->message_types   = $this->register_message_types();
    ...
    public function mark_as_read() {
        ...
        $success = $this->db->query(
            "UPDATE {$this->prefix}boston_messages SET status='read' WHERE id IN({$unread_id})"
        );
    ...
    public function get_unread_message_count( $user_id ) {
        return (int) $this->db->get_var(
            "SELECT count(id) FROM {$this->prefix}boston_messages WHERE status='unread' AND to_user_id={$user_id}"
        );
    }
