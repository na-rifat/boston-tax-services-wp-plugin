...
class Admin {
    ...
    public function get_tax_expert_assigner() {
        ...
        $atts = [
            ...
            'tax_expert_profile' => $this->user->profile_info( boston_var( 'tax_expert_id' ) ),
    ...
    public function current_client_count( $user_id ) {
        return (int) $this->db->get_var(
            "SELECT count(id) FROM {$this->prefix}boston_currently_assigned_clients WHERE tax_expert_id={$user_id}"
        );
    }
